...
class receprionUI(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2.setText(_translate("MainWindow", "Выполнить действие"))
        self.label_5.setText(_translate("MainWindow", "Выберите, что хотите сделать"))
        self.pushButton_3.setText(_translate("MainWindow", "Подтвердить запись"))
        self.label_3.setText(_translate("MainWindow", "Выберите строку из таблицы"))
        self.label_7.setText(_translate("MainWindow", "Выберите запись на приём"))
        self.pushButton_4.setText(_translate("MainWindow", "Отменить запись"))
        ...
        self.comboBox_4.addItem("Записаться на приём")
        self.comboBox_4.addItem("Отменить запись на приём")
        self.comboBox_6.addItem("Автозапись по специалисту")
        self.comboBox_6.addItem("Автозапись по персоналу")
        self.comboBox_6.addItem("Запись по специалисту")
        self.comboBox_6.addItem("Запись по персоналу")
